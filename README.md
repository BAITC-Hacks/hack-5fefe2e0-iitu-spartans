...
| Опционально: потоковая обработка, темп живого разговора | страница `/live` — Gemini Live API, один открытый поток и перебивание, сценарий выбирает наш LLM-слой через инструмент (раздел 12.2) | #45 |
