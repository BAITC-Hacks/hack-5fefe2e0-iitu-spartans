...
Ожидаемый результат: `Test Files 1 passed`, `Tests 11 passed`, проверка типов без ошибок.
...
| `OPENAI_API_KEY` | ключ для живого режима: распознавание, выбор сценария, синтез речи | добавляется с маршрутизатором |
